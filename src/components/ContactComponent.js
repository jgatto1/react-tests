...
class Contact extends Component {
    ...
    // binding form with state. If not, no changes are displayed when user input sth
    ...
    handleBlur = (field) => (evt) => {
        this.setState({
            touched: {...this.state.touched, [field]: true} //spread sintax. All inside the ...Element insert into anywhere
        });
